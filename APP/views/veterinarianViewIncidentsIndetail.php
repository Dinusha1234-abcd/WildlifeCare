            ...
            <tr>
                ...
                <td><?php
                    if ($data[1][0]['vetStatus'] == 'success') {
                        ...
                        echo  "<a href='../veterinarian/trigerRequest?lang=1&stat=accept&incidentId={$_GET['index']}'><button class='buttonAccept' id='acceptId' value='ACCEPT' name='accept'/>ACCEPT</button></a>";
                    }
